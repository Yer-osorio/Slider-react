...
const PruebasHooks = ( {contador, setContador } ) => {
  ...
  return (
    <div style={{display:"flex", flexDirection:"column", alignItems:"center", gap:"20px", background:"#8b5555", height:"600px"}}>
      ...
      >
        ...
        <img style={{width:"500px", height:"300px", justifyContent:"center", objectFit:"cover", borderRadius:"10%", border: "solid red 5px"}} src={img} alt="" />
    </div>
